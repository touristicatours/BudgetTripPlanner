...
import { z } from "zod";
import { itineraryService, ItineraryRequest } from "../services/itinerary_service";
...
export async function aiRoutes(fastify: FastifyInstance) {
  ...
  fastify.post("/qa", {}, async (request, reply) => {
    const { tripId, messages } = request.body as z.infer<typeof QASchema>;
  ...
  fastify.post("/itinerary", {}, async (request, reply) => {
    const requestData = request.body as z.infer<typeof ItineraryRequestSchema>;
